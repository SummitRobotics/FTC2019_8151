...
public class MoveByTime extends CoreAction {
    ...
    public MoveByTime(double time, double speed, int nextPos) {
  ...
  /*  public MoveByTime(double leftDistance, double rightDistance, double speed, int nextPos) {
    ...
    */
    ...
    public MoveByTime(double time, double leftSpeed, double rightSpeed, int nextPos) {
